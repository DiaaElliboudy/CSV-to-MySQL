...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 12, 2024 at 08:31 PM
...
--
-- Table structure for table `visafreeaccess`
--

CREATE TABLE `visafreeaccess` (
  `Country` text NOT NULL,
  `Rank` text NOT NULL,
  `VisaFreeAccess` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `visafreeaccess`
--

INSERT INTO `visafreeaccess` (`Country`, `Rank`, `VisaFreeAccess`) VALUES
('Singapore', '1st', '195'),
('Finland', '2nd', '192'),
('France', '2nd', '192'),
('Germany', '2nd', '192'),
